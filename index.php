...
<title>Merit Car Hire Portal</title>
<!--Bootstrap -->
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There are many variations of passenger <a href ="car-listing.php">vehicles available</a>. We are open to both Malawian and international clients as our online platform enables people to book a vehicle in advance making it possible for an international client to reserve a car prior to them getting to Malawi.</p>
    </div>
    <div class="row"> 
...
<span class="price">MWK<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
